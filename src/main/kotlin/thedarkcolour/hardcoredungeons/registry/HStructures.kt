...
object HStructures {
    ...
    val LUMLIGHT_CABIN = SimpleStructure.single("lumlight_cabin")
    ...
    val MUSHROOM_HUT_FEATURE: StructureFeature<*, *> = MUSHROOM_HUT.func_236391_a_(IFeatureConfig.NO_FEATURE_CONFIG)
    ...
    init {
        ...
        builder.put(LUMLIGHT_CABIN, StructureSeparationSettings(8, 32, 523332))

        Structure.field_236365_a_["Mushroom_Hut"] = MUSHROOM_HUT
        Structure.field_236365_a_["Rainbow_Factory"] = RAINBOW_FACTORY
        Structure.field_236365_a_["Lumlight_Cabin"] = LUMLIGHT_CABIN

        DimensionStructuresSettings.field_236191_b_ = builder.putAll(DimensionStructuresSettings.field_236191_b_).build()
    }
